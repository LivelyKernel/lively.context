/*global global, module, LivelyDebuggingASTRegistry*/

;(function(run) {
  var env = typeof module !== "undefined" && module.require ? module.require("../env") : Global;
  run(env.lively.ast.acorn, env.lively, env.lively.lang, env.lively.ast);

  if (env.isCommonJS) module.exports = env.lively.ast.Rewriting;
})(function(acorn, lively, lang, ast) {
    var exports = (lively.ast.Rewriting || (lively.ast.Rewriting = {}));
    ...
    lang['class'].create('lively.ast.Rewriting.Rewriter',
    "initializing", {
    ...
    'ast helpers', {
        ...
        newVariable: function(name, value) {
            ...
            } else if (lang.obj.isObject(value) && (value.type != null)) {
    ...
    'scoping', {
        ...
        enterScope: function(additionals) {
            ...
            return this.scopes.push(lang.obj.extend(additionals, {localVars: [], computationProgress: []}));
        },
        ...
        registerVars: function(varIdentifiers) {
            ...
            var scope = lang.arr.last(this.scopes),
                that = this;
        ...
        registerDeclarations: function(ast, visitor) {
            ...
            var scope = lang.arr.last(this.scopes), that = this, decls = {};
    ...
    'rewriting', {
        ...
        wrapVar: function(name) {
            ...
            for (var i = this.scopes.length - 1; i >= 0; i--) {
                if (lang.arr.include(this.scopes[i].localVars, name)) {
        ...
        storeComputationResult: function(node, start, end, astIndex, postfix) {
            ...
            lang.arr.last(this.scopes).computationProgress.push(pos);
    ...
    lang['class'].create(lively.ast.Rewriting.Rewriter, 'lively.ast.Rewriting.RecordingRewriter',
    "initializing", {
    ...
    var BaseVisitor = lang['class'].create('lively.ast.Rewriting.BaseVisitor',
    "visiting", {
    ...
    lang['class'].create(lively.ast.Rewriting.BaseVisitor, "lively.ast.Rewriting.RewriteVisitor",
    'initializing', {
    ...
    'visiting', {
        ...
        visitCallExpression: function(n, rewriter) {
            ...
            var args = n.arguments.map(function(n) {
                ...
                lastArg = lang.arr.last(args);

            if (lastArg !== undefined) {
                if (rewriter.isPrefixStored(lastArg))
                    lastArg = lastArg.right; // unwrap
                if (!rewriter.isPostfixStored(lastArg)) {
                    lastArg = args[args.length - 1] = rewriter.storeComputationResult(lastArg, lastArg.start, lastArg.end, lang.arr.last(n.arguments).astIndex, true);
        ...
        visitCatchClause: function(n, rewriter) {
            ...
            var start = n.param.start, end = n.param.end,
                param = lang.obj.extend({}, n.param), // manually copy param without wrapping
    ...
    lang['class'].create(lively.ast.Rewriting.RewriteVisitor, "lively.ast.Rewriting.RecordingVisitor",
    'initializing', {
