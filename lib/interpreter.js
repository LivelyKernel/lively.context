...
;(function(run) {
  ...
  if (env.isCommonJS && !env.Global.UnwindException) module.require('./exception');
  run(env.Global, env.lively.ast.acorn, env.escodegen, env.lively, env.lively.lang, env.lively.ast);

  if (env.isCommonJS) module.exports = env.lively.ast.AcornInterpreter;
})(function(Global, acorn, escodegen, lively, lang, ast) {
    var exports = (lively.ast.AcornInterpreter || (lively.ast.AcornInterpreter = {}));

  lang['class'].create('lively.ast.AcornInterpreter.Interpreter',
    'initialization', {
  ...
  'invoking', {
    ...
    invoke: function(recv, func, argValues, frame, isNew) {
      ...
      if (recv && lang.obj.isFunction(recv) && func === Function.prototype.apply) {
      ...
      if (isNew && !lang.obj.isObject(result))
        return recv;
      return result;
    },
  ...
  'execution', {
    ...
    shouldHaltAtNextStatement: function(node) {
    ...
    shouldHaltAtNextCall: function(node) {
  ...
  'visiting', {
    ...
    accept: function(node, state) {
      ...
      } else if (this.shouldHaltAtNextStatement(node) && lang.arr.include(this.statements, node.type)) {
  ...
  lang.obj.extend(lively.ast.AcornInterpreter.Interpreter, {

    stripInterpreterFrames: function(topFrame) {
      var allFrames = [topFrame];
      while (lang.arr.last(allFrames).getParentFrame())
        allFrames.push(lang.arr.last(allFrames).getParentFrame());
      allFrames = lang.arr.filter(allFrames, function(frame) {
  ...
  lang['class'].create('lively.ast.AcornInterpreter.Function',
  'settings', {
    ...
    prepareFunction: function(optFunc) {
      ...
      var fn = lang.obj.extend(
        ...
        forInterpretation: function(interpreter) {
          return function(/*args*/) { return self.apply(this, lang.arr.from(arguments), interpreter); }
        },
  ...
  'interpretation', {
    ...
    apply: function(thisObj, argValues, interpreter) {
      var // mapping = lang.obj.extend({}, this.getVarMapping()),
  ...
  lang['class'].create(  'lively.ast.AcornInterpreter.Frame',
  'initialization', {
    ...
    newScope: function(mapping) { return new lively.ast.AcornInterpreter.Scope(mapping, this.scope); },
      ...
      copy.alreadyComputed = lang.obj.extend({}, this.alreadyComputed);
      return copy;
  	},
  ...
  'testing', {
    ...
    isInternal: function() {
      ...
      return lang.arr.include(this._internalModules, this.getOriginalAst().sourceFile);
    }

  });

  lang.obj.extend(lively.ast.AcornInterpreter.Frame, {
  ...
  lang['class'].create('lively.ast.AcornInterpreter.Scope',
  'initialization', {
  ...
  lang.obj.extend(lively.ast.AcornInterpreter.Scope, {
    ...
    varMapping: function(scope) {
      ...
      return lang.obj.merge.apply(null,
